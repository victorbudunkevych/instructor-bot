...
def main():
    try:
        ...
        print(f"   490 грн: https://t.me/InstructorIF2_Test_bot?start=register490")
        print(f"   550 грн: https://t.me/InstructorIF2_Test_bot?start=register550")
